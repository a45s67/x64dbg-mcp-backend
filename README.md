...
backend entry; it does not require a separate configuration section:
...
The Gateway exposes these commands through `gateway.backend_control`. The
controller remains independently usable from a terminal.
