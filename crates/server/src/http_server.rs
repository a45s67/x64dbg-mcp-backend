...
mod tests {
    ...
    async fn tools_list_exposes_the_bounded_catalog() {
        ...
        assert!(tools.iter().any(|tool| tool["name"] == "trace.results"));
        ...
        assert!(
            tools
                .iter()
                .any(|tool| tool["name"] == "debuggee.launch_dll")
        );
        assert!(
            tools
                .iter()
                .any(|tool| tool["name"] == "debugger.run_to_address")
        );
        assert!(
            tools
                .iter()
        ...
        assert!(
            tools
                .iter()
                .any(|tool| tool["name"] == "breakpoints.exception.set")
        );
        assert!(
            tools
                .iter()
